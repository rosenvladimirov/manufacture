...
class MrpBomCost(models.AbstractModel):
    _name = 'report.mrp_bom_losses.mrp_bom_cost_report_loss'
        ...
        for bom in boms:
            ...
            for product in products:
                ...
                for bom_line, line_data in result2:
                    ...
                    line_data['qty'] = float_round(line_data['qty'], precision_rounding=rounding, rounding_method='UP')
                    ...
                    line = {
                        ...
                        'product_uom_qty_real': line_data['qty_real'],
