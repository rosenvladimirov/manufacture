...
class ReportBomStructure(models.AbstractModel):
    ...
    def _get_bom_lines(self, bom, bom_quantity, product, line_id, level):
        ...
        for line in bom.bom_line_ids:
            line_quantity = (bom_quantity / (bom.product_qty or 1.0)) * line.product_qty_real
            line_quantity_total = (bom_quantity / (bom.product_qty or 1.0)) * line.product_qty
            ...
            components.append({
                ...
                'prod_qty_total': line_quantity_total,
                ...
                'phantom_bom': line.child_bom_id and line.child_bom_id.type == 'phantom' or line.type == 'phantom' and line.product_id.current_bom_id,
    ...
    def _get_price(self, bom, factor, product):
        ...
        for line in bom.bom_line_ids:
            if line._skip_bom_line(product):
                continue
            if line.child_bom_id:
                qty = line.product_uom_id._compute_quantity(line.product_qty_real * factor, line.child_bom_id.product_uom_id) / line.child_bom_id.product_qty
                sub_price = self._get_price(line.child_bom_id, qty, line.product_id)
                price += sub_price
            else:
                prod_qty = line.product_qty_real * factor
